    ...
    return(
        ...
        <Overlay isVisible={ImageVisible} onBackdropPress={toggleImageOverlay}>
            ...
            <View style={{alignItems:'flex-end'}}>
                <Button onPress={toggleImageOverlay} title={<FontAwesome5 name="times" size={25} color="white" />} buttonStyle={styles.ImageCloseButton} />
            </View>
            <Gallery
                style={{ flex: 1, backgroundColor: 'white'}}
                scrollViewStyle={{borderColor:'black'}}
                images={[
                    { source: { uri: UserImage }, keyExtractor:'1' },
                    { source: { uri: AadharFrontImage }, keyExtractor:'1' },
                    { source: { uri: AadharBackImage }, keyExtractor:'1' },
                    { source: { uri: PanImage }, keyExtractor:'1' },
                ]}
            />
